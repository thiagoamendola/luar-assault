...
def main(argv=None):
    ...
    defs_path = scenes_dir / 'music_viewer_scene_defs.h'
    ...
    header_content = f'''#ifndef MUSIC_VIEWER_SCENE_DEFS_H
...
inline const music_viewer_scene::music_entry entries[music_count{" + 1" if count_value == 0 else ""}] = {{
{entries_block}
}};
}} // namespace music_viewer_defs
