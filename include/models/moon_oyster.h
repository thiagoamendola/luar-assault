    ...
    namespace fr::model_3d_items
    {
        constexpr inline vertex_3d moon_oyster_vertices[] = {
             vertex_3d(0.0,-9.53507,0.0),
             vertex_3d(0.0,9.53507,-0.0),
             vertex_3d(9.53507,0.0,0.0),
             vertex_3d(-9.53507,0.0,0.0),
             vertex_3d(-5.21109,5.21109,-0.0),
             vertex_3d(5.21109,5.21109,-0.0),
             vertex_3d(5.21109,-5.21109,0.0),
             vertex_3d(-5.21109,-5.21109,0.0),
             vertex_3d(0.0,-13.22565,8.25198),
             vertex_3d(0.0,13.22565,8.25198),
             vertex_3d(-13.22565,0.0,8.25198),
             vertex_3d(13.22565,0.0,8.25198),
             vertex_3d(0.0,-0.0,-9.029810000000001),
             vertex_3d(0.0,-6.0832,7.15732),
             vertex_3d(0.0,6.0832,7.15732),
             vertex_3d(6.0832,0.0,7.15732),
             vertex_3d(-6.0832,0.0,7.15732),
             vertex_3d(0.0,0.0,1.07412),
             vertex_3d(0.0,0.0,13.24052),
       };
