    ...
    namespace fr::model_3d_items
    {
        constexpr inline vertex_3d asteroid1_vertices[] = {
             vertex_3d(8.07544,8.07544,8.07544),
             vertex_3d(-8.07544,8.9874,-4.21868),
             vertex_3d(-8.13376,8.07544,12.47842),
             vertex_3d(-6.3842,-4.63628,8.07544),
             vertex_3d(4.57236,-1.4008399999999999,-4.9724),
       };
    ...
    constexpr inline face_3d asteroid1_faces_full[] = {
        ...
        face_3d(asteroid1_vertices, vertex_3d(0.0148,0.9984,0.0546),0,1,2,0,7),
