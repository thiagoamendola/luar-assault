...
[[nodiscard]] bn::sprite_palettes_fade_to_action
_create_sprites_fade_in_action()
{
      ...
      _background_move_action(_background_bg, 1, -1)
{
    ...
    bn::sprite_text_generator &big_text_generator =
        common_stuff.big_text_generator;
    ...
    big_text_generator.generate(0, 16, "github.com/GValiente/butano",
                                _text_sprites);
