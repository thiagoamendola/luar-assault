...
hyperlight_background::hyperlight_background() :
...
void hyperlight_background::_draw_star(int sx, int sy, int color_index)
{
    // 3x3 cross pattern
...
void hyperlight_background::update(const fr::camera_3d& camera)
{
